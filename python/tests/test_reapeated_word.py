...
def test_happy_path():
    input_string = 'This is a pretty pretty good path.'
    test_repeat = RepeatedWord()
    actual = test_repeat.repeat_word(input_string)
    expected = 'pretty'
...
def test_if_no_repeats():
    input_string = "Ethel is a baby girl."
    test_repeat = RepeatedWord()
    actual = test_repeat.repeat_word(input_string)
    expected = None
    assert actual == expected    